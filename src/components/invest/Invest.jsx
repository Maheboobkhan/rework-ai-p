...
const Invest = () => {
    return (
        <div className="flex flex-col justify-center items-center py-9 bg-violet-100 px-4 sm:w-[65%] mx-auto">
            <div className="font-Archivo self-stretch text-2xl sm:text-4xl font-extrabold leading-8 text-center text-black whitespace-nowrap">
                Invest in Your Future
            </div>
            <div className="font-Archivo mt-3 text-xs sm:leading-5 sm:text-[18px] font-semibold text-center text-black text-opacity-60">
