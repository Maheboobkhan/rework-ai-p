...
const Invest = () => {
    return (
        <div className="flex flex-col justify-center items-center py-9 bg-violet-100">
            ...
            <div className="font-Archivo justify-center px-7 py-1.5 mt-6 text-sm font-medium leading-7 border-2 text-white capitalize whitespace-nowrap bg-violet-800 hover:bg-white hover:text-violet-800 hover:border-violet-800">
                Apply now
            </div>
        </div>
    )
