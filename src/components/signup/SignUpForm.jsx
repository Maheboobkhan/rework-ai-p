...
const SelectField = ({ label, name, options, placeholder, value, onChange, error }) => (
    <div className="">
        ...
        <select name={name} className="justify-center items-start p-2 w-full text-base max-md:text-xs whitespace-nowrap rounded-lg border border-solid bg-zinc-50 border-stone-300 appearance-none custom-select" value={value} onChange={onChange}>
            <option className='p-3 max-md:p-2 border border-solid border-stone-300 text-sm max-md:text-xs' value="" disabled>{placeholder}</option>
