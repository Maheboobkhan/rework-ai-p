    ...
    return (
        <main className="flex flex-col pt-2 w-full bg-[#FFFFFF]">
            <section className=" flex flex-col w-full px-3 pb-2 bg-violet-800 rounded-t-lg">
                ...
                <div className="my-20 font-Archivo text-3xl lg:text-4xl text-start max-sm:text-center font-black text-neutral-100  custom-welcome-text max-sm:mx-8 max-sm:font-bold">
            ...
            <div className="flex flex-col max-md:ml-0 max-md:w-full">
                <img
                    ...
                    className="h-[40vh] lg:w-[30vw] bg-red-600 max-sm:w-screen max-sm:h-[20%] object-fill object-center"
                />
            </div>
        </main>
    )
