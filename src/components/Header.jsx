    ...
    <nav className={`px-5 md:px-20 py-2 ${isNavbarFixed ? 'fixed top-0 left-0 z-50 w-full bg-white border-b-[0.5px] border-[#c6c2c2]' : 'relative bg-white'}`}>
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:block">
          <button className="text-white whitespace-nowrap bg-violet-800 max-md:px-5 max-md:mt-10 px-7 py-2.5 font-bold hover:bg-white font-Archivo-700 hover:text-violet-800 hover:border-2 hover:border-violet-800 cursor-pointer transition-all transition-duration: 400ms;"
